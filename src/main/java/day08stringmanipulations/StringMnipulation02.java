...
public class StringMnipulation02 {
    public static void main(String[] args) {
        ...
        char sonHarf = isim.charAt(isim.length() - 1);//Yazdiginiz code'a sadece bazi durumlar icin calisirsa o code'a "Hard Coding" denir
        ...
        //Example:Ilk isim ve soy isimi iceren isimlerden ilk ve soy isimlerin bas harfalerini ekrana yazdirin
