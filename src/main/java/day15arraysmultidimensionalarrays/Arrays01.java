...
public class Arrays01 {
    public static void main(String[] args) {
        ...
        //                       binarySearch() Method'u aradığınız eleman Array'de yoksa ne yapar?
        //                       binarySearch() Method'u aradığınız eleman Array'de yoksa "-a" seklinde bir negatif sayi alirsiniz
