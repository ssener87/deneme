...
public class Scanner02 {
    ...
    /*
    Note:char varibale'lari matematiksel islemlerde kullanirsiniz, Java onlarin  ASCII degerlerini kullanir.
...
//           Ali Can ==> AC
       ...
       // System.out.println("" + ilk + son);
        ...
        char soyIsminIlkHarfi=tamIsim.split(" ")[1].charAt(0);//split=parcalamak anlamina gelir
