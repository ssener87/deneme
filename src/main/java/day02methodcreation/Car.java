...
public class Car {
    ...
    public static void main(String[] args) {
        ...
        //1)Class ismini yaziniz  2)Objeye bir isim veriniz  3)=  4)new keyword'unu kullanin   5)Class ismi parantezle beraber(Constructor)
                 Car                      myHonda              =               new                   Car();
        ...
        MethodCreation obj=new MethodCreation(); //8.0
